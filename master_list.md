...
* [*Shivaram Venkataraman*](https://shivaram.org/)
  * One of the more published HPC people at UW-Madison in recent years
  * **Research Interests**: designing systems and algorithms for large scale data analysis and machine learning
  * :x: Researched (2+ Papers Read)
  * :x: Contacted (Email of interest sent)
...
* No GRE requirement
* CS PhD students minor in another topic
* [N+1 Institute](https://nplus1.wisc.edu/)
* [Mad Systems](https://madsystems.cs.wisc.edu/)
* [Heterogeneous Architectures Lab (HAL)](https://research.cs.wisc.edu/hal/)
